 ...
 */
const textures = [
  textureLoader.load("../../static/textures/particles/1.png"),
  textureLoader.load("../../static/textures/particles/2.png"),
  textureLoader.load("../../static/textures/particles/3.png"),
  textureLoader.load("../../static/textures/particles/4.png"),
  textureLoader.load("../../static/textures/particles/5.png"),
  textureLoader.load("../../static/textures/particles/6.png"),
  textureLoader.load("../../static/textures/particles/7.png"),
  textureLoader.load("../../static/textures/particles/8.png"),
];
